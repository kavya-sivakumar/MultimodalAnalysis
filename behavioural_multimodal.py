# ============================================================
# Behavioral Coding + Physiological Fusion Pipeline
# ============================================================
# Research context:
#   Do children show more prosocial behaviour following 
#   a performance art experience? 
#
#   This pipeline links observer-coded behavioral
...
# ----------------------------------------------------------------
# 1. SYNTHETIC DATA — behavioral event log + continuous HRV
# ----------------------------------------------------------------
# Simulate a behavioral coding session
#
#
# Behavioral events coded:
...
def simulate_participant(pid, condition, seed):
    ...
    # Behavioral events — arts condition has more prosocial events
...
# ----------------------------------------------------------------
# Extract HRV epochs around each behavioral event 
...
# ----------------------------------------------------------------
# One row per participant: behavioral counts + mean HRV features
...
# ----------------------------------------------------------------
# 6. RANDOM FOREST — predict condition from behavioral + HRV features
# ----------------------------------------------------------------
...
fig.suptitle("Behavioral Coding + Physiological Fusion", fontsize=14,
             fontweight="bold")
...
out_path = OUT_DIR / "behavioral_multimodal_results.png"
